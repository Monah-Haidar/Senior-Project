...
//     if (!title && !content && !market_conditions && !mood && !img && !entry_date){
...
//     const queryString = `UPDATE journal_entries SET ${fields.join(", ")} WHERE entry_id = $${fields.length + 1} RETURNING *;` ;
//     console.log(queryString);
